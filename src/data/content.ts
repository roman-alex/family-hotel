...
export const pricing = {
  ...
  rooms: [
    { name: 'Двомісні', prices: [1400, 1600, 1400] },
    { name: 'Двомісні (покращені)', prices: [1600, 1800, 1600] },
    { name: 'Тримісні (з балконом)', prices: [1900, 2400, 1900] },
    { name: 'Тримісні (без балкону)', prices: [1600, 2000, 2000] },
