...
export const pricing = {
  ...
  rooms: [
    { name: 'Двомісний стандарт', prices: [1400, 1600, 1400] },
    { name: 'Двомісний покращений з терасою', prices: [1600, 1800, 1600] },
    { name: 'Тримісний з балконом', prices: [1900, 2400, 1900] },
    { name: 'Тримісний без балкона', prices: [1600, 2000, 2000] },
    { name: 'Апартаменти до 8 осіб', prices: [3800, 4800, 3800] },
    { name: 'Апартаменти до 6 осіб', prices: [3200, 3800, 3200] },
  ],
